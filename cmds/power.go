...
func (cmds *CommandSet) HelpForPower() cmd.ExitCode {
...
func (cmds *CommandSet) Start(args []string) cmd.ExitCode {
...
func (cmds *CommandSet) Shutdown(args []string) cmd.ExitCode {
	flags := cmd.MakeCommonFlagSet()
...
func (cmds *CommandSet) Stop(args []string) cmd.ExitCode {
	flags := cmd.MakeCommonFlagSet()
	flags.Parse(args)
	args = cmds.config.ImportFlags(flags)
...
func (cmds *CommandSet) Restart(args []string) cmd.ExitCode {
	flags := cmd.MakeCommonFlagSet()
	flags.Parse(args)
	args = cmds.config.ImportFlags(flags)
...
func (cmds *CommandSet) ResetVM(args []string) cmd.ExitCode {
	flags := cmd.MakeCommonFlagSet()
	flags.Parse(args)
	args = cmds.config.ImportFlags(flags)
