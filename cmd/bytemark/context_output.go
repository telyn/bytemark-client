...
const (
	...
	DefaultHeadTableFields = "ID, Label, IsOnline, UsageStrategy, UUID, CCAddress, CountVirtualMachines, FreeMemory, UsedCores, TotalMemory, LastNote, Architecture, Models, ZoneName"
