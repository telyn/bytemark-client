...
func (c *bytemarkClient) DeleteVirtualMachine(name pathers.VirtualMachineName, purge bool) (err error) {
...
func (c *bytemarkClient) GetVirtualMachine(name pathers.VirtualMachineName) (vm brain.VirtualMachine, err error) {
	var r Request
...
func (c *bytemarkClient) MoveVirtualMachine(oldName pathers.VirtualMachineName, newName pathers.VirtualMachineName) (err error) {
...
func (c *bytemarkClient) ReimageVirtualMachine(name pathers.VirtualMachineName, image brain.ImageInstall) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// returns nil on success or an error otherwise.
func (c *bytemarkClient) ResetVirtualMachine(name pathers.VirtualMachineName) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// returns nil on success or an error otherwise.
func (c *bytemarkClient) RestartVirtualMachine(name pathers.VirtualMachineName) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// returns nil on success or an error otherwise.
func (c *bytemarkClient) StartVirtualMachine(name pathers.VirtualMachineName) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// returns nil on success or an error otherwise.
func (c *bytemarkClient) StopVirtualMachine(name pathers.VirtualMachineName) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// returns nil on success or an error otherwise.
func (c *bytemarkClient) ShutdownVirtualMachine(name pathers.VirtualMachineName, stayoff bool) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return
	}
...
func (c *bytemarkClient) UndeleteVirtualMachine(name pathers.VirtualMachineName) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// Return nil on success, an error otherwise.
func (c *bytemarkClient) SetVirtualMachineHardwareProfile(name pathers.VirtualMachineName, profile string, locked ...bool) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// Return nil on success, an error otherwise.
func (c *bytemarkClient) SetVirtualMachineHardwareProfileLock(name pathers.VirtualMachineName, locked bool) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// Return nil on success, an error otherwise.
func (c *bytemarkClient) SetVirtualMachineMemory(name pathers.VirtualMachineName, memory int) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
// Return nil on success, an error otherwise.
func (c *bytemarkClient) SetVirtualMachineCores(name pathers.VirtualMachineName, cores int) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
...
func (c *bytemarkClient) SetVirtualMachineCDROM(name pathers.VirtualMachineName, url string) (err error) {
	err = c.EnsureVirtualMachineName(&name)
	if err != nil {
		return err
	}
